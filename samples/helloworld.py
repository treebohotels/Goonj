...
def run_sample():
    ...
    source_name1_alert.info("with rule engine ", sev=Sev.HIGH, subject="subjecr", error_id="1234", error=None,
                            tag_list=["tag1", "tag2"])
    source_name1_alert.info("with rule engine ", sev=Sev.HIGH, subject="subjecr", error_id="1234", error=None,
                            tag_list=["tag1", "tag2"])
    source_name1_alert.info("with rule engine ", sev=Sev.HIGH, subject="subjecr", error_id="1234", error=None,
    ...
    source_name1_alert.info("with rule engine ", sev=Sev.HIGH, subject="subjecr", error_id="1234", error=None,
                            tag_list=["tag1", "tag2"])
    source_name1_alert.info("dsgfds", Sev.HIGH, "subjecr", "1", None,
                            ["tag1", "tag2"])
...
def run_sample1():
    ...
    core.Goonj(config_file_path='goonj.yaml')
    source_name1_alert = get_smart_alert('source_name1', logger)
    source_name1_alert.info("dsgfds", sev=Sev.HIGH, subject="subjecr", error_id="1", error=None,
                            tag_list=["tag1", "tag2"])
    source_name1_alert.info("dsgfds", Sev.HIGH, "subjecr", "1", None,
                            ["tag1", "tag2"])
